...
class CartAddAddressFrom(forms.Form):
    ...
    first_name = forms.CharField(max_length=50, required=False,label=_("First name"),widget=forms.TextInput(attrs={"class":tailwind_classes,"placeholder":'نام*'}))
    last_name = forms.CharField(max_length=50, required=False, label=_("Last name"),widget=forms.TextInput(attrs={"class":tailwind_classes,"placeholder":'نام خانوادگی*'}))
    ...
    postal_code = forms.IntegerField(required=False, validators=[postal_code_validator], label=_("Postal code"),widget=forms.TextInput(attrs={"class":tailwind_classes,"placeholder":'کد پستی'}))
    ...
    phone_number = forms.IntegerField(required=True,validators=[phone_number_validator], label=_("Phone number"),widget=forms.TextInput(attrs={"class":tailwind_classes,"placeholder":'تلفن*'}))
